...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductPicker = function () {
	  function ProductPicker(options, target, cb) {
	    _classCallCheck(this, ProductPicker);
...
/***/ function(module, exports) {
	...
	var Search = function () {
	  ...
	  _createClass(Search, [{
	    key: 'prepareIndexing',
	    value: function prepareIndexing() {
	    ...
	    key: 'searchInObject',
	    value: function searchInObject() {
	      var _this = this;
	      this._allProducts.map(function (index, item) {
	        var pattern = _this._seachContainer.val().toLowerCase(),
